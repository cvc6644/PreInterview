...
function palindrome($input){
    //Removes all Invalid characters and converts all valid characters to lowecase
...
function runPalindrome(){
    ...
    //because why not test against the longest palindrome
    echo palindrome("Star? Not I! Movie – it too has a star in or a cameo who wore mask – cast are livewires.
